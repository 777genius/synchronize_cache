...
import 'conflict_e2e_test.drift.dart' as i3;
import 'conflict_e2e_test.dart' as i4;
...
class $$TestEntitiesTableFilterComposer
  ...
  i0.ColumnFilters<int> get mood => $composableBuilder(
    column: $table.mood,
    builder: (column) => i0.ColumnFilters(column),
  );

  i0.ColumnFilters<int> get energy => $composableBuilder(
    column: $table.energy,
    builder: (column) => i0.ColumnFilters(column),
  );
  ...
  i0.ColumnFilters<String> get settings => $composableBuilder(
...
class $$TestEntitiesTableOrderingComposer
  ...
  i0.ColumnOrderings<int> get mood => $composableBuilder(
    column: $table.mood,
    builder: (column) => i0.ColumnOrderings(column),
  );

  i0.ColumnOrderings<int> get energy => $composableBuilder(
    column: $table.energy,
    builder: (column) => i0.ColumnOrderings(column),
  );
  ...
  i0.ColumnOrderings<String> get settings => $composableBuilder(
    column: $table.settings,
    builder: (column) => i0.ColumnOrderings(column),
  );
...
class $$TestEntitiesTableAnnotationComposer
  ...
  i0.GeneratedColumn<int> get mood =>
      $composableBuilder(column: $table.mood, builder: (column) => column);

  i0.GeneratedColumn<int> get energy =>
      $composableBuilder(column: $table.energy, builder: (column) => column);

  i0.GeneratedColumn<String> get notes =>
      $composableBuilder(column: $table.notes, builder: (column) => column);

  i0.GeneratedColumn<String> get settings =>
        ...
        i0.TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                i0.Value<int?> mood = const i0.Value.absent(),
                i0.Value<int?> energy = const i0.Value.absent(),
                i0.Value<String?> notes = const i0.Value.absent(),
                i0.Value<String?> settings = const i0.Value.absent(),
...
class $TestEntitiesTable extends i4.TestEntities
  ...
  static const i0.VerificationMeta _moodMeta = const i0.VerificationMeta(
    'mood',
  );
  @override
  late final i0.GeneratedColumn<int> mood = i0.GeneratedColumn<int>(
    'mood',
    aliasedName,
    true,
  ...
  static const i0.VerificationMeta _energyMeta = const i0.VerificationMeta(
    'energy',
  );
  @override
  late final i0.GeneratedColumn<int> energy = i0.GeneratedColumn<int>(
    'energy',
    aliasedName,
    true,
    type: i0.DriftSqlType.int,
  ...
  static const i0.VerificationMeta _settingsMeta = const i0.VerificationMeta(
    'settings',
  );
  @override
  late final i0.GeneratedColumn<String> settings = i0.GeneratedColumn<String>(
    'settings',
    aliasedName,
    true,
    type: i0.DriftSqlType.string,
...
class TestEntitiesCompanion extends i0.UpdateCompanion<i4.TestEntity> {
  ...
  final i0.Value<int?> mood;
  final i0.Value<int?> energy;
  final i0.Value<String?> notes;
  final i0.Value<String?> settings;
  ...
  const TestEntitiesCompanion({
    ...
    this.energy = const i0.Value.absent(),
    this.notes = const i0.Value.absent(),
    this.settings = const i0.Value.absent(),
  ...
  static i0.Insertable<i4.TestEntity> custom({
    ...
    i0.Expression<int>? mood,
    i0.Expression<int>? energy,
    i0.Expression<String>? notes,
    i0.Expression<String>? settings,
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    ...
    if (mood.present) {
      map['mood'] = i0.Variable<int>(mood.value);
    }
    if (energy.present) {
      map['energy'] = i0.Variable<int>(energy.value);
    }
    if (notes.present) {
      map['notes'] = i0.Variable<String>(notes.value);
    }
    if (settings.present) {
      map['settings'] = i0.Variable<String>(settings.value);
    }
    if (tags.present) {
...
class _$TestEntityInsertable implements i0.Insertable<i4.TestEntity> {
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    return i3.TestEntitiesCompanion(
      ...
      mood: i0.Value(_object.mood),
      energy: i0.Value(_object.energy),
      notes: i0.Value(_object.notes),
      settings: i0.Value(_object.settings),
